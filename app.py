"""
Skin Disease Detector - Python Flask Backend (Google Gemini)
=============================================================
...
# Strict Structured Output Schema to enforce reliable field parameters
...
def analyze():
    ...
    try:
        ...
        return jsonify({"error": "Model response structure failed runtime validation.", "raw": raw_text[:300]}), 500
